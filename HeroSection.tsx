          ...
          <div className="lg:col-span-6 xl:col-span-5 space-y-6 lg:space-y-8 px-4 lg:px-0">
            ...
            <div className="space-y-2">
              <p className="text-base lg:text-lg text-muted-foreground animate-fade-in">
                Hey, I am <span className="gradient-text font-semibold">Aditya</span>
              </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up">
              <Button 
                variant="default" 
                size="lg" 
                className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-6 lg:px-8 py-4 lg:py-6 rounded-full shadow-glow hover:shadow-elegant transition-all duration-300"
              >
                Hire me
              </Button>
              <Button 
            ...
            <div className="flex flex-wrap gap-2 lg:gap-3 pt-2 lg:pt-4">
              {['React', 'TypeScript', 'Node.js', 'Tailwind CSS'].map((skill, index) => (
                <span 
                  key={skill}
                  className="px-3 lg:px-4 py-2 bg-secondary/50 text-secondary-foreground rounded-full text-xs lg:text-sm font-medium border border-border/20 hover:border-primary/30 transition-colors duration-300 animate-fade-in-up"
